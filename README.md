## Al ejecutar la aplicación, lo primero que veremos será un splash en el que se podrá ver el logo de la aplicación parpadeando y el nombre de la aplicación justo debajo.
